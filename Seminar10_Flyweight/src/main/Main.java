...
public class Main {
    public static void main(String[] args) {
        ...
        registru.getClient("Fabian","123456789","fabian@gmail.com").afiseazaRezervare(rezervare1);
        registru.getClient("Fabian","123456789","fabian@gmail.com").afiseazaRezervare(rezervare2);
        Rezervare rezervare3=new Rezervare(3,4,20);
        registru.getClient("Fabian","123456789","fabian@gmail.com").afiseazaRezervare(rezervare3);
